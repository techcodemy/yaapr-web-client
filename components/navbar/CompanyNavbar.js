            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg relative flex flex-col justify-between h-full">
                <section className="flex flex-col flex-1">
                    ...
                    <ul className="flex-1 flex flex-col my-3 bg-gray-50 dark:bg-gray-800 rounded-lg p-2">
                        ...
                        <li className="transition duration-500 hover:bg-indigo-50 dark:bg-gray-800 dark:hover:bg-gray-900  cursor-pointer rounded-lg ">
                            <Link href={`/bus/${router.query.bus_slug}/messenger`}>
                                <a className="py-2 flex group items-center relative">
                                    ...
                                    <span className="absolute right-0 bg-red-600 text-white text-xxs rounded p-1 mr-2">23</span>
                                </a>
                            </Link>
                        </li>
                        <li className="transition duration-500 hover:bg-indigo-50 dark:bg-gray-800 dark:hover:bg-gray-900  cursor-pointer rounded-lg ">
                ...
                <section className="mb-1">
                    <div className="py-2">
                        <span className="text-sm leading-tight text-gray-600 dark:text-gray-100 tracking-tight">You are using the free tier,<br/> Please upgrade for best features<br/> <a href="#" className="hover:underline text text-indigo-600 dark:text-indigo-300">Learn More...</a></span>
                    </div>
                    <button href="#" className="py-2 btn btn--primary w-full">
                        Upgrade
                    </button>
                </section>
